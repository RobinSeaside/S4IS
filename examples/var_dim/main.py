...
def var_dim(theta):
    ...
    """
    n_dim = hard_model_hparams['dim']
    y_out = (n_dim + 3 * 0.2 * np.sqrt(n_dim)) - np.sum(theta, axis=1)
...
dir_demo = base + 'examples/var_dim/'
verbose = 0
random_seed = 2018
# Hard model
hard_model_hparams = {
...
infill_params_1 = {
    ...
    'MPP': np.array([0.97691168, 0.97691168, 0.97691168, 0.97691168, 0.97691168,
       0.97691168, 0.97691168, 0.97691168, 0.97691168, 0.97776033]),
